...
const config = {
  ...
  api : {
    ...
    TENANT_PUBLIC_FIELDS               : ['uuid', 'domain', 'title', 'logo'],
    TENANT_ORGANIZATION_PUBLIC_FIELDS  : ['uuid', 'subdomain', 'title', 'logo'],
    AGENT_PRIVATE_FIELDS               : ['secret'],
    USER_PRIVATE_FIELDS                : ['password', 'secret', 'refreshToken'],
    USER_SEARCH_INDEXED_FIELDS         : ['uuid', 'firstName', 'lastName', 'email', 'birthday', 'portrait', 'zip'],
