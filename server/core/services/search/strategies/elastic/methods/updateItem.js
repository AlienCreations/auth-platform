 ...
 * later in order to update a searchable item in the Elastic index.
 ...
 * @returns {Promise}
 */
const updateItem = R.curry((index, type, item) => {
  return Promise.resolve(item)
    .then(createAction('update', index, type))
    .then(R.append({ doc : item }))
