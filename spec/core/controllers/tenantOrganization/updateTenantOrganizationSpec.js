...
describe('tenantOrganizationCtrl.updateTenantOrganization', () => {
  ...
  it('updates an tenantOrganization when provided an id and new properties to update', done => {
    updateTenantOrganization(FAKE_TENANT_UPDATE_DATA, KNOWN_TEST_TENANT_ID)
      .then(res => {
  ...
  it('throws an error when updating an tenantOrganization that does not exist', done => {
    updateTenantOrganization(FAKE_TENANT_UPDATE_DATA, FAKE_UNKNOWN_TENANT_ID)
      .catch(err => {
